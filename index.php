...
<body>
  <div class="container">
    <div class="row">
      <p><a href="login.php"><button class="btn-primary">Login/Daftar</button></a> Sekarang untuk mulai mencari kost yang tersedia</p>

    </div>
    <div class="row">
      <p class="display-4">Daftar kost yang tersedia</p>
      <hr>
    </div>
